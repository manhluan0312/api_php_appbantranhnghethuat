...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 19, 2022 lúc 06:11 AM
...
(1, 'Admin_xuan_0322', 'Nguyễn Văn Xuân', 'xuan0312', NULL, 'xuan215@gmail.com', '0322456548', '23 Hoang Xa,Ung Hoa ,Ha Noi');
...
(1, 'luan0312', 'Nguyễn Thành Luân', NULL, 'manhluan1234@gmail.com', 'luan1234', '0325514581', 'Ứng Hòa ,Hà Nội'),
...
(52, 3, 'Trả tiền mặt', '2022-05-16 09:55:36', 'Hà Nội', 'giao sớm', 27000000, 'Đang xử lý');
...
(64, 'Tranh loai một1', 'abcd.jpg', 700000, 'Sơn dầu1', '80*70cm', 2020, 'tranh rất đẹp1', 'null', 5);
...
--
ALTER TABLE `orders`
  MODIFY `id_order` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Mã đơn hàng', AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT cho bảng `order_details`
--
ALTER TABLE `order_details`
  MODIFY `id_order_detail` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Mã chi tiết đơn hàng', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `products`
--
ALTER TABLE `products`
  MODIFY `id_product` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Mã sản phẩm', AUTO_INCREMENT=65;
