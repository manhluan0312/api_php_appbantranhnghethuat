...
$query="SELECT * FROM orders WHERE id_customer='".$id."'AND `Delivery_status`='Đã xử lý' ORDER BY id_order DESC";//sap xep ma don hang giam dan
...
if(!empty($result))//kiem tra co don hang hay khong
{
